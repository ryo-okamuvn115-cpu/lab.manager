...
export default function ProtocolPage() {
  ...
  const handleDelete = async (id: string) => {
    if (!window.confirm('このプロトコルを削除しますか？')) {
      return;
    }
  ...
  return (
    <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
      ...
      {loading ? (
              ...
              <div key={protocol.id} className="overflow-hidden rounded-lg bg-white shadow transition hover:shadow-md">
                  ...
                  >
                    <div>
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-3">
                        ...
                        <span className="text-sm text-gray-600">目安: {protocol.estimatedTime}</span>
                      </div>
                    </div>
                    {isExpanded ? (
                ...
                {isExpanded && (
                  <div className="border-t border-gray-200 bg-gray-50 p-6">
                    ...
                    <div>
                      <h4 className="mb-3 font-semibold text-gray-900">手順</h4>
                          ...
                          <div key={step.stepNumber} className="rounded border border-gray-200 bg-white p-4">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                ...
                                {step.duration && (
                                  <p className="mt-2 text-xs text-gray-500">所要時間: {step.duration}</p>
                                )}
                              </div>
                            </div>
                          </div>
        ...
        <div className="py-12 text-center text-gray-500">プロトコルはまだありません</div>
      )}
